...
const Points = () => {
  return (
    <section id='services' class="bg-black dark:bg-gray-900 h-screen w-screen ">
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="max-w-screen-md mb-8 lg:mb-16">
            <h2 class="text-left mb-4 text-4xl tracking-tight font-extrabold text-cyan">Who is it for ?</h2>
        ...
        <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
                ...
                <h3 class="text-left mb-2 text-xl font-bold text-cyan">Non-profits</h3>
                <p class="text-gray-500 text-white text-left">Run an online auction as a stand-alone fundraiser or as part of a live event.</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <h3 class="text-left mb-2 text-xl font-bold text-cyan">Education</h3>
                <p class="text-gray-500 text-white text-left">Run a fundraising auction for your school with donations from parents and supporters</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <h3 class="text-left mb-2 text-xl font-bold text-cyan">Business</h3>
                <p class="text-gray-500 text-white text-left">Auction surplus stock, offer deals to employees or raise money for a good cause</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <h3 class="text-left mb-2 text-xl font-bold text-cyan">Technology</h3>
                <p class="text-gray-500 text-white text-left">Run online auction for technical products</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <h3 class="text-left mb-2 text-xl font-bold text-cyan">Individual</h3>
                <p class="text-gray-500 text-white text-left" >Raise money for a business venture, an expedition, or any other worthy cause</p>
            </div>
            <div>
                <div class="flex justify-center items-center w-full mb-4  h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <h3 class="text-left mb-2 text-xl font-bold text-cyan">Clubs</h3>
                <p class="text-gray-500 text-white text-left">Raise money for a sporting or social club - perhaps together with a live event.</p>
            </div>
        </div>
    </div>
  </section>
